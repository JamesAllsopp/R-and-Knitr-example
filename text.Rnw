...
Save this text file as \texttt{text.Rnw} and we'll use the \href{knitr}{https://yihui.org/knitr/} package in
\href{https://www.r-project.org}{R} to process this it to a \href{.tex} file before compiling it in \LaTeX to produce a
PDF.
...
\begin{itemize}
\item \href{http://edrub.in/ARE212/latexKnitr.html}{here}
\item \href{https://sachsmc.github.io/knit-git-markr-guide/knitr/knit.html}{here}
